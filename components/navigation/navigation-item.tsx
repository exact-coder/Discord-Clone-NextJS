  ...
  return (
    <ActionTooltip side='right' align='center' label={name}>
        <button className="group relative flex items-center" onClick={onClick}>
            ...
            <div className={cn("relative group mx-3 h-[48px] w-[48px] rounded-[24px] group-hover:rounded-[16px] transition-all overflow-hidden", params?.serverId === id && "bg-primary/10 text-primary rounded-[16px]")}>
